      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto space-y-12">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-balance">
            {t.comparison.title} <span className="text-muted-foreground">{t.comparison.titleEnd}</span>
          </h2>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-border">
                  <th className="text-left py-4 px-4 font-bold text-lg">{t.comparison.tableHeaders.feature}</th>
