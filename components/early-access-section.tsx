...
export function EarlyAccessSection() {
  ...
  const handleAlphaSignup = () => {
    router.push("/?program=Alpha#demo");
  };

  const handleBetaSignup = () => {
    router.push("/?program=Beta#demo");
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {t.earlyAccess.tiers.map((tier, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-gradient-to-r from-[#ED2009] to-[#FF5B19] p-[2px] rounded-2xl"
                >
                  <div className="bg-card rounded-2xl p-8 h-full space-y-6">
                    ...
                    >
                      {isAlpha
                        ? t.earlyAccess.cta.alpha
                        : t.earlyAccess.cta.beta}
                    </Button>
                  </div>
                </div>
              );
